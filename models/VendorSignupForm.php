...
class VendorSignupForm extends Model
{
    ...
    public function rules()
    {
        return [
            ['username', 'trim'],
            ['username', 'required'],
            ['username', 'unique', 'targetClass' => '\app\models\Vuser', 'message' => 'This username has already been taken.'],
            ...
            ['email', 'unique', 'targetClass' => '\app\models\Vuser', 'message' => 'This email address has already been taken.'],
